...
'Because it has access to the outer function scope.'
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach((element) => {
      ...
      // console.log('animal name', element['animal_name'] && element['scientific_name'])
...
console.log(animalNames(zooAnimals))
  ...
  */
  ...
  function USApop(zooAnimals){
    let usaPop = zooAnimals.reduce ((accumulator, currentValue) => {
